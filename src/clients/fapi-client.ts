...
class FapiClient {
  ...
  private normalizeMatch(raw: any): NormalizedMatch | null {
    ...
    const homeScore = this.toNullableNumber(raw.home_score ?? raw.homeScore ?? raw.score_home);
    const awayScore = this.toNullableNumber(raw.away_score ?? raw.awayScore ?? raw.score_away);
